...
from .views import PlanPPDAView, ComunaView, RegionView, CiudadView, OrganismoResponsableView
from .views import OrganismosResponsablesView, ReporteListView, ReporteEstadoUpdateView,ReporteView
